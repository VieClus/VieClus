...
int parse_parameters(int argn, char **argv,
        ...
        struct arg_int *mh_louvain_iterations                = arg_int0(NULL, "mh_louvain_iterations", NULL, "Number of Louvain iterations.");
